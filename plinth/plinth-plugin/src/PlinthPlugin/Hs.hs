...
app ::
  ...
  Ghc.LHsExpr Ghc.GhcPs ->
  Ghc.LHsExpr Ghc.GhcPs
app s f x = Ghc.L (Ghc.noAnnSrcSpan s) $
#if __GLASGOW_HASKELL__ >= 910
  Ghc.HsApp Ghc.noExtField f x
#else
  Ghc.HsApp Ghc.noAnn f x
#endif
...
lam ::
  ...
  Ghc.MatchGroup Ghc.GhcPs (Ghc.LHsExpr Ghc.GhcPs) ->
  Ghc.LHsExpr Ghc.GhcPs
lam s mg_ = Ghc.L (Ghc.noAnnSrcSpan s) $
#if __GLASGOW_HASKELL__ >= 910
  Ghc.HsLam Ghc.noAnn Ghc.LamSingle mg_
#else
  Ghc.HsLam Ghc.noExtField mg_
#endif
...
lit s l = Ghc.L (Ghc.noAnnSrcSpan s) $
#if __GLASGOW_HASKELL__ >= 910
  Ghc.HsLit Ghc.noExtField l
#else
  Ghc.HsLit Ghc.noAnn l
#endif
...
#else
    Ghc.Match Ghc.noAnn Ghc.LambdaExpr ps g
#endif
...
#else
    Ghc.Match Ghc.noAnn Ghc.CaseAlt ps g
#endif
...
funTy s a b =
  Ghc.L (Ghc.noAnnSrcSpan s) $
#if __GLASGOW_HASKELL__ >= 910
    Ghc.HsFunTy Ghc.noExtField unrestrictedArrow a b
#else
    Ghc.HsFunTy Ghc.noAnn unrestrictedArrow a b
#endif
...
#else
    Ghc.UserTyVar Ghc.noAnn () (Ghc.L (Ghc.noAnnSrcSpan s) v)
#endif
...
mg ms =
  Ghc.MG
#if __GLASGOW_HASKELL__ >= 910
    (Ghc.Generated Ghc.OtherExpansion Ghc.SkipPmc)
#else
    Ghc.Generated
#endif
    (Ghc.noLocA (Ghc.unLoc ms))
...
opApp ::
  ...
  Ghc.LHsExpr Ghc.GhcPs ->
  Ghc.LHsExpr Ghc.GhcPs
opApp s l o r = Ghc.L (Ghc.noAnnSrcSpan s) $
#if __GLASGOW_HASKELL__ >= 910
  Ghc.OpApp Ghc.noExtField l o r
#else
  Ghc.OpApp Ghc.noAnn l o r
#endif

par :: Ghc.SrcSpan -> Ghc.LHsExpr Ghc.GhcPs -> Ghc.LHsExpr Ghc.GhcPs
par s e = Ghc.L (Ghc.noAnnSrcSpan s) $
#if __GLASGOW_HASKELL__ >= 910
  Ghc.HsPar Ghc.noAnn e
#else
  Ghc.HsPar Ghc.noAnn Ghc.noHsTok e Ghc.noHsTok
#endif
...
recFields fs =
#if __GLASGOW_HASKELL__ >= 910
  Ghc.HsRecFields Ghc.noExtField fs Nothing
#else
  Ghc.HsRecFields fs Nothing
#endif
