...
import qualified PlinthPlugin.Generator.AsData as AsData
import qualified PlinthPlugin.Generator.Match as Match
import qualified PlinthPlugin.Generator.Optics as Optics
import qualified PlinthPlugin.Generator.Common as Common
import GHC.Hs
import qualified PlinthPlugin.Hsc as Hsc
import qualified PlinthPlugin.Options as Options
import qualified PlinthPlugin.Type.Config as Config
import qualified PlinthPlugin.Type.Flag as Flag
import qualified GHC.Hs as Ghc
import qualified GHC.Plugins as Ghc
import qualified Paths_plinth_plugin as This
...
-- requiring a @-fplugin=PlinthPlugin@ pragma.
--
  ...
  case Ghc.unLoc lHsDerivingClause of
    Ghc.HsDerivingClause _ deriv_clause_strategy deriv_clause_tys
      | Just options <- Common.parseDerivingStrategy deriv_clause_strategy -> do
          let nonPlinthPluginClauses = filter
          ...
          (dropOriginal, lImportDecls, lHsDecls) <-
            handleLHsSigTypes config moduleName lIdP lHsQTyVars lConDecls options nonPlinthPluginClauses
              . toLHsSigTypes
